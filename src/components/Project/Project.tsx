        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/divyanshuu8/Xeno-SDE-Internship/tree/deployment"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://xeno-internship.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              <h3>Mi-CMS: Mini CRM Platform</h3>
              <p>
                Mi-CMS is a full-stack CRM platform for customer segmentation,
                personalized campaign delivery, and AI-driven insights. Built
                with React (Vite) and Node.js/Express, it integrates MongoDB for
                data storage and OpenAI for smart suggestions. Features include
                Google OAuth login, customer & order management, campaign
                creation, and AI-powered communication logs.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
